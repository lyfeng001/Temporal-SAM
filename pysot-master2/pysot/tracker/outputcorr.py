...
parser.add_argument('--dataset', default='/media/lyf/工作/study/kd_lowillum/new/UAVDark135', type=str,
        help='datasets')
parser.add_argument('--config', default='/media/lyf/0E28062C0E28062C/mskd-full/pysot-master2/experiments/siamrpn_alex_dwxcorr/config.yaml', type=str,
        help='config file')
parser.add_argument('--snapshot', default='/home/user/V4R/LYF/pysot-master2/snapshot/checkpoint_e4.pth', type=str,
        help='snapshot of models to eval')
parser.add_argument('--video', default='pedestrian2', type=str,
...
def main():
    ...
    # zf = model4.backbone(template)
    # xf = model4.backbone(search)
    # print(zf.shape)
    # print(xf.shape)
