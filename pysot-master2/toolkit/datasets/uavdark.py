...
def loaddata(dataset_root):
    ...
    name_list=os.listdir(dataset_root+'/Sequences')
    name_list.sort()
    ...
    for jj in range(len(name_list)):
        imgs=dataset_root+'/Sequences/'+str(name_list[jj])
...
class UAVDARKDataset(Dataset):
    ...
    def __init__(self, name, dataset_root, load_img=False):
        super(UAVDARKDataset, self).__init__(name, dataset_root)
