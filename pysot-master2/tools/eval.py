...
def main():
    tracker_dir = '/media/lyf/工作/study/kd_lowillum/new/UAVDark135_TSP_out/rainbow'#os.path.join(args.tracker_path, args.dataset)
    # trackers = glob(os.path.join(args.tracker_path,
    #                               args.dataset,
    #                               args.tracker_prefix))
    trackers = ['multi-student','self-learned teacher','student+Spa Loss','student+Rescls Loss','student+L2 Loss','self-learning student'] #[x.split('/')[-1] for x in args.tracker_prefix.split(',')]

    root = '/media/lyf/工作/study/kd_lowillum/new/UAVDark135_TSP_out'#args.dataset_dir + args.dataset
