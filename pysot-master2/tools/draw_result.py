...
##tea
    ...
    cv2.rectangle(img, (int(gt_bbox[0]), int(gt_bbox[1])),(int(gt_bbox[0])+int(gt_bbox[2]), int(gt_bbox[1])+int(gt_bbox[3])), (0, 255, 255), 5)
##spa
    gt_bbox1 = [856.7904866922415,727.2778143266784,42.97837266460963,139.81902801271352]
    cv2.rectangle(img, (int(gt_bbox1[0]), int(gt_bbox1[1])),(int(gt_bbox1[0])+int(gt_bbox1[2]), int(gt_bbox1[1])+int(gt_bbox1[3])), (0, 255, 0), 5)
##mcl
    gt_bbox2 = [856.7813424380435,728.4820529928671,43.78735310456317,140.85868773083058]
    cv2.rectangle(img, (int(gt_bbox2[0]), int(gt_bbox2[1])),(int(gt_bbox2[0])+int(gt_bbox2[2]), int(gt_bbox2[1])+int(gt_bbox2[3])), (0, 0, 255), 5)
##L2
    gt_bbox3 = [855.867382043132,727.9610641600038,43.97888681390802,138.78199319171298]
    cv2.rectangle(img, (int(gt_bbox3[0]), int(gt_bbox3[1])),(int(gt_bbox3[0])+int(gt_bbox3[2]), int(gt_bbox3[1])+int(gt_bbox3[3])), (255, 0, 0), 5)
